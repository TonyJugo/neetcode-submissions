public class Solution {
    public int Trap(int[] height) {
        ...
        // return res;
        //4. two pointer
        //y tuong chỉ can biet vach ben nao thap nhat thi co the tinh duoc muc nuoc o vi tri hien tai
        int res = 0;
        ...
        while(l < r){
            if(leftMax < rightMax){
                l++;
                //tinh leftmax dong thoi xem day co phai la buc tuong hay ko
                leftMax = Math.Max(leftMax, height[l]);
                //neu la buc tuong thi - height se ra 0
                res += leftMax - height[l];
            }else{
                //vach ben phai nho hon
                r--;
